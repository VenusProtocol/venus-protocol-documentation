...
* **Flexible Distribution Rules**: The incomes generated by Venus Protocol are distributed according to two schemas. The percentages below are the BNB Chain configuration since [VIP-638](https://venus.io/governance/proposal/638?chainId=56) (1 July 2026, [Tokenomics Phase II](https://community.venus.io/t/venus-tokenomics-phase-ii-prime-rewards-redesign/5774)); XVS Vault rewards are no longer a destination, and deployments below the revenue-eligibility threshold route 100% to the Treasury (see [Tokenomics](../governance/tokenomics.md)).
  ...
  * **Schema (ADDITIONAL\_REVENUE)**: Valid for liquidation and other product developments.
    ...
    * 20% to Venus Prime
    * 20% to Risk Fund
* **Buyback Delivery**: Since [VIP-620](https://venus.io/governance/proposal/620?chainId=56) (May 2026) every destination is a single-purpose TokenBuyback contract. The Prime share is bought into USDT and U and forwarded to the PrimeLiquidityProvider, the Risk Fund share into USDT for RiskFundV2, and the Treasury share into U, BTCB, ETH, USDT, USDC and XVS for the VTreasury. An off-chain operator triggers the swaps.
